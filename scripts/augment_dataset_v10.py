...
BASE_TRANSFORMS = {
    ...
    "bright_iso": ["bright", "iso_noise"], "bright_blur": ["bright", "blur"], 
    "vstrip": ["vstrip"], "stretch": ["stretch"]  # stretchを追加
}
...
def apply_seq(img, ops, args):
    ...
    for op in ops:
        ...
        elif op == "stretch": out = apply_stretch(out, tuple(args.stretch_range))  # stretchの実行
    return out
