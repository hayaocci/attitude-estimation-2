...
def load_one_exp(exp_dir: Path, split: str) -> pd.DataFrame | None:
    ...
    # eval_<valid_root_short>_<split>_kf_latest/eval_results_kf.csv を想定
    eval_dir = exp_dir / f"eval_{valid_root_short}_{split}_kf_latest"
...
def main():
    ...
    out_csv = compilation_dir / f"comp_results_{split}_kf_latest.csv"
